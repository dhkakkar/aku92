...
<head>
    ...
    <title>AKU92 — Excellence in Medical Care | {{ config('site.name') }}</title>
    ...
    <div class="main-grid">
        ...
        <div class="card-hub">
            ...
            <div class="card-hub-content">
                ...
                <div class="card-hub-badge">Multi-Specialty OPD</div>
        ...
        <div class="card-hub">
            ...
            <div class="card-hub-content">
                ...
                <div class="card-hub-badge">Pharmacy &bull; Since 1987</div>
        ...
        <div class="card-hub">
            ...
            <div class="card-hub-content">
                ...
                <div class="card-hub-badge">Publications</div>
        ...
        <div class="card-hub">
            ...
            <div class="card-hub-content">
                ...
                <p class="card-hub-desc">Surgical supplies & equipment at D.A.V. Market, Holkar Chowk.</p>
                <div class="card-hub-cta"><span class="cta-line"></span> Explore <i class="fas fa-arrow-right"></i></div>
            </div>
            <a href="{{ url('/shop') }}"></a>
        </div>
        ...
        <div class="card-hub card-hub--cta">
            <div class="card-hub-content">
                <div class="card-hub-icon"><i class="fas fa-file-medical"></i></div>
